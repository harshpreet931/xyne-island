...
import { boardsOperations } from '../registry/boards.js';
...
export class BoardsResource extends Resource {
     ...
     */
    listStagesByProject(projectId, options) {
     ...
     */
    listTransitionsForBoards(boardIds) {
     ...
     */
    listSlaPoliciesForBoards(boardIds) {
     ...
     */
    listComplexityScores(userGroupId) {
     ...
     * ]);
     */
    syncTransitions(boardId, transitions) {
