...
import { type MessageCursor } from '../registry/messages.js';
...
export declare class MessagesResource extends Resource {
    /**
     ...
     */
    listByConversation(conversationId: string, options?: PageOptions): Promise<Page<Message>>;
    /**
     ...
     */
    listByChannel(channelId: string, options?: PageOptions): Promise<Page<Message>>;
    /**
     ...
     */
    listChannelAttachments(channelId: string, options?: {
        limit?: number;
        start?: {
     ...
     */
    clearDraft(channelId: string, options?: {
        conversationId?: string;
    }): Promise<void>;
    /**
