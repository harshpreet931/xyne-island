...
export class WorkspaceResource extends Resource {
     ...
     */
    async shareLink(linkId, userIds) {
        ...
        await this.call(workspaceOperations.shareLink, {
            ...
            accessIds: userIds.map((u) => accessIdMap[u]),
        });
     ...
     */
    updateSdlcTrack(trackId, updates) {
     ...
     */
    listClassificationMappings(channelId) {
     ...
     */
    updateClassificationMapping(id, data) {
     ...
     */
    deleteClassificationMapping(id) {
