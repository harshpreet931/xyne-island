...
import { incidentsOperations } from '../registry/incidents.js';
...
export class IncidentsResource extends Resource {
     ...
     */
    listImpactAttachments(impactId) {
     ...
     */
    listAttachmentsForImpacts(impactIds) {
     ...
     */
    listApplicationReleaseTickets(releaseId, limit) {
     ...
     */
    listReleaseChangeFormValues(releaseId) {
     ...
     */
    listReleaseChangeLog(releaseId) {
     ...
     */
    updateReleaseTicketStatus(id, data) {
     ...
     */
    setReleaseTicketTestedBy(id, userId) {
     ...
     */
    listReleaseEvents(releaseId, limit) {
