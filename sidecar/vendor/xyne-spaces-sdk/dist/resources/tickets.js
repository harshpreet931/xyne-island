...
import { ticketsOperations, } from '../registry/tickets.js';
...
export class TicketsResource extends Resource {
     ...
     */
    async listActivities(ticketId, options) {
     ...
     */
    listReleaseAttributions(ticketId) {
     ...
     */
    setStageEta(id, stageEta, options) {
     ...
     */
    listSubTicketMappings(ticketIds) {
     ...
     */
    updateSubTicket(subTicketId, data) {
     ...
     */
    addTag(ticketId, projectId, tagName) {
     ...
     */
    addReference(sourceTicketId, targetTicketId, relationType) {
     ...
     */
    updateReference(id, relationType) {
     ...
     */
    transitionStage(ticketId, toStageName, options) {
     ...
     */
    listSubTicketsByMapped(mappedTicketId) {
     ...
     */
    getSubTicketByMapped(mappedTicketId) {
