...
import { conversationsOperations, } from '../registry/conversations.js';
...
export class ConversationsResource extends Resource {
     ...
     */
    listLatestByChannel(channelId, options) {
     ...
     */
    getWithChannel(conversationId, channelId, options) {
     ...
     */
    getThread(conversationId, options) {
     ...
     */
    getMyParticipation(conversationId) {
     ...
     */
    listAppliedLabels(conversationId, channelId) {
     ...
     */
    markUnreadFrom(conversationId, messageId) {
     ...
     */
    getByTimestamp(channelId, timestamp, options) {
     ...
     */
    setTagTypes(conversationId, types, options) {
