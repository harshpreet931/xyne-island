...
export class CollectionsResource extends Resource {
     ...
     */
    listSubfolders(rootCollectionId) {
     ...
     */
    listFilesByRoot(rootCollectionId) {
     ...
     */
    renameItem(id, collectionId, name) {
     ...
     */
    revokePermission(id, collectionId) {
