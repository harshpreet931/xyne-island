...
export class RecapsResource extends Resource {
     ...
     */
    listForChannels(channelIds, recapDate) {
     ...
     */
    listDaily(channelIds, recapDate) {
     ...
     */
    setCustomPrompt(channelId, prompt) {
     ...
     */
    markChannelRead(channelId, recapDate) {
     ...
     */
    listEntityNudges(sourceId, states) {
     ...
     */
    listNudgesByCountRows(countRowIds) {
