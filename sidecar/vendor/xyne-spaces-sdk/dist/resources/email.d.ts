...
import { type EmailCursor, type EmailDraftCursor } from '../registry/email.js';
...
export declare class EmailResource extends Resource {
    /**
     ...
     */
    listForConversations(conversationIds: string[], channelId: string, isMember?: boolean): Promise<Email[]>;
    /**
     ...
     */
    listSent(channelId: string, options?: {
        limit?: number;
        start?: EmailCursor;
        scope?: string;
    }): Promise<Email[]>;
     ...
     */
    listDrafts(channelId: string, options?: {
        limit?: number;
     ...
     */
    getDraftForConversation(conversationId: string, channelId: string, isMember?: boolean): Promise<EmailDraft | null>;
    /**
     ...
     */
    updateSignature(id: string, data: {
        name: string;
        content: string;
    }): Promise<void>;
    /**
     ...
     */
    setChannelPreference(channelId: string, data: {
        ownerUserId?: string;
