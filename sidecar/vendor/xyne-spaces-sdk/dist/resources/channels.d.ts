...
export declare class ChannelsResource extends Resource {
     ...
     */
    listBrowsable(options?: PageOptions): Promise<Page<Channel>>;
    /**
     ...
     * });
     */
    create(data: CreateChannelInput): Promise<{
        id: string;
    }>;
    /**
     ...
     */
    updateParticipantRole(channelId: string, userId: string, role: ChannelRole): Promise<void>;
    /**
     * Rename a channel.
     *
     ...
     */
    markAsViewed(channelId: string, options?: {
     ...
     */
    moveToSection(channelId: string, sectionId: string | null, position: string): Promise<void>;
    /**
     ...
     */
    markUnreadFrom(channelId: string, messageId: string, options?: {
        conversationId?: string;
    }): Promise<void>;
    /**
     ...
     */
    listParticipantsPaginated(channelId: string, options?: {
        limit?: number;
        start?: {
            role: string;
            userId: string;
