...
export class UserGroupsResource extends Resource {
     ...
     */
    listMembersForGroups(userGroupIds) {
     ...
     */
    async addUsers(userGroupId, userIds, options) {
     ...
     */
    listAssignmentStates(userGroupId) {
     ...
     */
    listAssignmentStatesForGroups(userGroupIds) {
     ...
     */
    listWorkloadMappings(userGroupId) {
     ...
     */
    getAssignmentStateForUser(userId) {
     ...
     */
    listExpertise(userGroupId, boardId) {
     ...
     * });
     */
    toggleAutoRotation(userGroupId, autoRotationEnabled, options) {
