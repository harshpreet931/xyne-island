...
import { emailOperations, } from '../registry/email.js';
...
export class EmailResource extends Resource {
     ...
     */
    listForConversations(conversationIds, channelId, isMember) {
     ...
     */
    getDraftForConversation(conversationId, channelId, isMember) {
     ...
     */
    setChannelPreference(channelId, data) {
     ...
     */
    listConversationsByLabel(labelId) {
