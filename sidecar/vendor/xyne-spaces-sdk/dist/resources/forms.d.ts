...
import { type FormFieldInput } from '../registry/forms.js';
...
export declare class FormsResource extends Resource {
     ...
     * );
     */
    listMappingsByContextIds(contextIds: string[], contextType: FormContextType, entityType: FormEntityType): Promise<FormContextMapping[]>;
    /**
     ...
     */
    getMapping(contextId: string, contextType: FormContextType, entityType: FormEntityType): Promise<FormContextMapping | null>;
    /**
     ...
     */
    deleteMapping(contextId: string, contextType: FormContextType, entityType: FormEntityType): Promise<void>;
    /**
     ...
     */
    updateValue(formEntityValueId: string, newValue: unknown, options?: {
