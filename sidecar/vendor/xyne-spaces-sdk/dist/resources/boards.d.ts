...
import { type StageInput } from '../registry/boards.js';
import type { Board, BoardComplexityScore, BoardSlaPolicy, ChannelBoardMapping, FlowPlan, FormContextMapping, SavedView, Stage, StageTransition, StageTransitionInput, TicketPriority } from '../types/index.js';
export declare class BoardsResource extends Resource {
    /**
     ...
     */
    listStagesByProject(projectId: string, options?: {
        boardType?: string;
    }): Promise<Stage[]>;
    /**
