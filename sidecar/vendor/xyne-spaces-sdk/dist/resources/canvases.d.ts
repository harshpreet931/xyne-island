...
import { type CanvasCursor, type CanvasScope } from '../registry/canvases.js';
...
export declare class CanvasesResource extends Resource {
    /**
     ...
     */
    listByChannel(channelId: string, options?: {
        limit?: number;
        start?: CanvasCursor;
        includeQuartoDocs?: boolean;
    }): Promise<Canvas[]>;
     ...
     */
    listQuartoDocsByChannel(channelId: string, options?: {
        limit?: number;
        start?: CanvasCursor;
    }): Promise<Canvas[]>;
    /**
     ...
     */
    listByFolder(folderId: string, projectId: string, options?: {
        includeQuartoDocs?: boolean;
    }): Promise<Canvas[]>;
    /**
     ...
     */
    addGroupParticipant(canvasId: string, userGroupId: string, role: CanvasRole): Promise<void>;
    /**
     ...
     */
    addChannelParticipant(canvasId: string, channelId: string, role: CanvasRole): Promise<void>;
    /**
     ...
     */
    updateParticipantRole(canvasId: string, userId: string, role: CanvasRole): Promise<void>;
    /**
     ...
     */
    updateGroupParticipantRole(canvasId: string, userGroupId: string, role: CanvasRole): Promise<void>;
    /**
     ...
     */
    updateChannelParticipantRole(canvasId: string, channelId: string, role: CanvasRole): Promise<void>;
    /**
     ...
     */
    updateComment(commentId: string, body: string, options?: {
        mentionedUserIds?: string[];
    }): Promise<void>;
    /**
     * Delete a comment.
