...
import { messagesOperations } from '../registry/messages.js';
...
export class MessagesResource extends Resource {
     ...
     */
    setShowInChannel(messageId, showInChannel) {
     ...
     */
    closeSlashCommandArtifact(messageId) {
     ...
     */
    listAttachmentsForThread(initialMessageId) {
     ...
     */
    listChannelAttachments(channelId, options) {
