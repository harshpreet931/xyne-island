...
import { adminOperations } from '../registry/admin.js';
...
export class AdminResource extends Resource {
     ...
     */
    async addOrgToWorkspace(workspaceId, orgId) {
        const id = newId();
     ...
     */
    removeOrgFromWorkspace(workspaceId, orgId) {
     ...
     */
    updateUserRole(workspaceId, userId, updates) {
