...
import { canvasesOperations, } from '../registry/canvases.js';
...
export class CanvasesResource extends Resource {
     ...
     */
    listByChannel(channelId, options) {
     ...
     */
    listQuartoDocsByChannel(channelId, options) {
     ...
     */
    listByFolder(folderId, projectId, options) {
     ...
     */
    addParticipants(canvasId, userIds, role) {
     ...
     */
    addGroupParticipant(canvasId, userGroupId, role) {
     ...
     */
    addChannelParticipant(canvasId, channelId, role) {
     ...
     */
    removeGroupParticipant(canvasId, userGroupId) {
     ...
     */
    removeChannelParticipant(canvasId, channelId) {
     ...
     */
    updateParticipantRole(canvasId, userId, role) {
     ...
     */
    updateGroupParticipantRole(canvasId, userGroupId, role) {
     ...
     */
    updateChannelParticipantRole(canvasId, channelId, role) {
