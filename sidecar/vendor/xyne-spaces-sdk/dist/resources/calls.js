...
import { callsOperations } from '../registry/calls.js';
...
export class CallsResource extends Resource {
     ...
     */
    linkNotesCanvas(callId, notesCanvasId) {
     ...
     */
    approveLobbyRequest(callId, participantId) {
     ...
     */
    rejectLobbyRequest(callId, participantId) {
