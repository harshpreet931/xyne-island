...
export class ChannelsResource extends Resource {
     ...
     */
    searchParticipants(channelId, searchQuery) {
     ...
     */
    getMyParticipations(channelIds) {
     ...
     */
    updateParticipantRole(channelId, userId, role) {
     ...
     */
    updateDescription(channelId, description) {
     ...
     */
    markAsViewed(channelId, options) {
     ...
     */
    moveToSection(channelId, sectionId, position) {
     ...
     */
    markUnreadFrom(channelId, messageId, options) {
     ...
     */
    setAddUserPolicy(channelId, policy) {
     ...
     */
    setCallSummaryPrompt(channelId, prompt) {
     ...
     */
    setSelectedBoard(channelId, boardId) {
     ...
     */
    setShowTicketsInChat(channelId, show) {
     ...
     */
    getStatsForChannels(channelIds) {
     ...
     */
    listParticipantsPaginated(channelId, options) {
