...
import { type ActivityCursor } from '../registry/activities.js';
import type { Activity, Bookmark } from '../types/index.js';
export declare class ActivitiesResource extends Resource {
    /**
     ...
     */
    markThreadAsRead(conversationId: string, options?: {
        draftMessage?: string;
    }): Promise<void>;
    /**
