...
import { type ConversationCursor } from '../registry/conversations.js';
import type { Conversation, ConversationLabel, ConversationLabelMapping, ConversationParticipant, CreateConversationWithAttachmentsInput, MessageType } from '../types/index.js';
export declare class ConversationsResource extends Resource {
    /**
     ...
     */
    listLatestByChannel(channelId: string, options?: {
        limit?: number;
        isMember?: boolean;
    }): Promise<Conversation[]>;
    /**
     ...
     */
    getWithChannel(conversationId: string, channelId: string, options?: {
        isMember?: boolean;
     ...
     */
    getThread(conversationId: string, options?: {
        channelId?: string;
        isMember?: boolean;
    }): Promise<Conversation | null>;
    /**
     ...
     */
    getLatest(channelId: string, options?: {
        isMember?: boolean;
    }): Promise<Conversation | null>;
    /**
     ...
     */
    listPinned(channelId: string, options?: {
        isMember?: boolean;
    }): Promise<Conversation[]>;
    /**
     ...
     * });
     */
    createWithAttachments(data: CreateConversationWithAttachmentsInput): Promise<{
        conversationId: string;
        messageId: string;
    }>;
    /**
     ...
     */
    getByTimestamp(channelId: string, timestamp: number, options?: {
        isMember?: boolean;
    }): Promise<Conversation | null>;
    /**
     ...
     */
    setTagTypes(conversationId: string, types: string[], options?: {
        note?: string;
    }): Promise<void>;
}
