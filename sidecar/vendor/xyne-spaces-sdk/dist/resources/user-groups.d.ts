...
export declare class UserGroupsResource extends Resource {
    /**
     ...
     */
    update(userGroupId: string, data: {
        name?: string;
        alias?: string;
        description?: string;
     ...
     */
    addUsers(userGroupId: string, userIds: string[], options?: {
        roleIds?: string[];
    }): Promise<{
     ...
     * });
     */
    toggleAutoRotation(userGroupId: string, autoRotationEnabled: boolean, options?: {
