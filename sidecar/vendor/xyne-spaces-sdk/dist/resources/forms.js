...
import { formsOperations } from '../registry/forms.js';
...
export class FormsResource extends Resource {
     ...
     * );
     */
    listMappingsByContextIds(contextIds, contextType, entityType) {
     ...
     */
    getMapping(contextId, contextType, entityType) {
     ...
     */
    listMappingsForBoards(boardIds) {
     ...
     */
    deleteMapping(contextId, contextType, entityType) {
     ...
     */
    updateValue(formEntityValueId, newValue, options) {
