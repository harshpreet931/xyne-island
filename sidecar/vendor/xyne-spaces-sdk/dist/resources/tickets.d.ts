...
import { type KanbanColumnType, type KanbanTicketFilters, type TicketActivityCursor, type TicketCursor, type TicketViewMode } from '../registry/tickets.js';
import { type Page, type PageOptions } from '../core/paginate.js';
import type { CreateTicketInput, CreateTicketResponse, Email, MailboxState, MessageAttachment, ProjectTag, Rca, ReleaseAttribution, StageRequestStatus, SubTicket, SubTicketMapping, Ticket, TicketActivity, TicketAssignment, TicketExport, TicketFieldDefinition, TicketMailbox, TicketPriority, TicketReferenceRelation, TicketStageRequest, TicketStatusV2, Workflow } from '../types/index.js';
export declare class TicketsResource extends Resource {
    /**
     ...
     */
    listByProject(projectId: string, options?: PageOptions): Promise<Page<Ticket>>;
    /**
     ...
     */
    listActivities(ticketId: string, options?: PageOptions): Promise<Page<TicketActivity>>;
    /**
     ...
     */
    setStageEta(id: string, stageEta: number, options?: {
        ticketId?: string;
        stageId?: string;
    }): Promise<void>;
    /**
     ...
     */
    updateSubTicket(subTicketId: string, data: {
        assignedTo?: string;
     ...
     */
    addReference(sourceTicketId: string, targetTicketId: string, relationType: TicketReferenceRelation): Promise<void>;
    /**
     ...
     */
    transitionStage(ticketId: string, toStageName: string, options?: {
