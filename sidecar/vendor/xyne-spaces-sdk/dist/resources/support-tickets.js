...
import { supportTicketsOperations, } from '../registry/support-tickets.js';
export class SupportTicketsResource extends Resource {
     ...
     * });
     */
    listFiltered(channelId, filters) {
     ...
     */
    getByKey(xyneId, workspaceId, channelId, options) {
