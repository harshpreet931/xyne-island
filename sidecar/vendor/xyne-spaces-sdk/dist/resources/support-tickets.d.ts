...
import { type SupportTicketCursor } from '../registry/support-tickets.js';
import type { Ticket, TicketPriority } from '../types/index.js';
export declare class SupportTicketsResource extends Resource {
    /**
     ...
     * });
     */
    listFiltered(channelId: string, filters?: {
        merchantMid?: string;
        assignedTo?: string[];
        priority?: TicketPriority[];
        stageName?: string[];
     ...
     */
    get(id: string, channelId: string, options?: {
        isMember?: boolean;
    }): Promise<Ticket | null>;
    /**
     ...
     */
    getByKey(xyneId: string, workspaceId: string, channelId: string, options?: {
        isMember?: boolean;
    }): Promise<Ticket | null>;
    /**
