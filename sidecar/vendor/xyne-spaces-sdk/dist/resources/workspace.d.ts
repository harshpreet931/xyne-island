...
export declare class WorkspaceResource extends Resource {
    /**
     ...
     */
    shareLink(linkId: string, userIds: string[]): Promise<{
        accessIds: Record<string, string>;
    }>;
    /**
     ...
     */
    updateSdlcTrack(trackId: string, updates: {
        name?: string;
     ...
     * });
     */
    createClassificationMapping(data: {
        channelId: string;
        category: string;
        userGroupId: string;
        subCategory?: string;
     ...
     */
    updateClassificationMapping(id: string, data: {
        category?: string;
        subCategory?: string;
        userGroupId?: string;
    }): Promise<void>;
