...
import { type CallCursor } from '../registry/calls.js';
import type { Call, CallParticipant, CallType, Conversation, RecurringCallSeries, SummaryTemplate } from '../types/index.js';
export declare class CallsResource extends Resource {
    /**
