...
export type Operation<TArgs = unknown, TResult = unknown> = ApiOperation<TArgs, TResult> | SdkOperation<TArgs, TResult>;
/**
 ...
 */
export declare function api<TArgs = void, TResult = unknown>(method: HttpMethod, path: string | ((args: TArgs) => string), options?: {
 ...
 */
export declare function firstOrNull<T>(raw: unknown): T | null;
/**
 ...
 */
export declare function op<TArgs = void, TResult = unknown>(id: string, kind: 'query' | 'mutator' | 'direct', options?: {
    mapResult?: (raw: unknown) => TResult;
